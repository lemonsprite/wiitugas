                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?= base_url('autentikasi/masuk'); ?>" method='post'>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Email</label>
                                                <input class="form-control py-4" id="inputEmailAddress" name='email' type="email" placeholder="Enter email address" value="<?php set_value('email'); ?>" />
